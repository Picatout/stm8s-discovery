...
;      MACROS
;--------------------------------------------------------
		.macro _ledenable ; set PD0 as output
		bset PD_DDR,#BIT0
		.endm
...
__interrupt_vect:
	...
	int NonHandledInterrupt ;int0
	int NonHandledInterrupt ;int1
	int NonHandledInterrupt ;int2
	int NonHandledInterrupt ;int3
	int NonHandledInterrupt ;int4
	int NonHandledInterrupt ;int5
	int NonHandledInterrupt ;int6
	int NonHandledInterrupt ;int7
	int NonHandledInterrupt ;int8
	int NonHandledInterrupt ;int9
	int NonHandledInterrupt ;int10
	int NonHandledInterrupt ;int11
	int NonHandledInterrupt ;int12
	int NonHandledInterrupt ;int13
	int NonHandledInterrupt ;int14
	int NonHandledInterrupt ;int15
	int NonHandledInterrupt ;int16
	int NonHandledInterrupt ;int17
	int NonHandledInterrupt ;int18
	int NonHandledInterrupt ;int19
	...
	int NonHandledInterrupt ;int27
	int NonHandledInterrupt ;int28
	int NonHandledInterrupt ;int29
...
;	bset CLK_PCKENR1,#CLK_PCKENR1_UART2
	...
	; baud rate
	mov UART2_BRR2,#0xb ; must be loaded first
	mov UART2_BRR1,#0x8
...
1$: pop a
	...
	; transmit character in a via UART2
